...
function AddToGroup({setFocused, focused, setExtend, extend, addFriend, friend}: Prop) {
    ...
    return <>
        <div>
            <div className={["w-[clamp(13rem,25vw,100rem)] h-[5vh] rounded-[1vw] bg-violet-300 overflow-y-scroll no-scrollbar flex flex-col", extend ? "h-[25vh]" : "", focused ? "bg-white": ""].join(" ")}>
