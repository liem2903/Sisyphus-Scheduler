...
function FriendBlock({last_seen, id, changed_name, status, openCalendar, setBusyDates, startWeek, endWeek, setCalendarId}: prop) {
    ...
    return <>
        <div className='perspective-[1000px]'>
            <div className={flipped? "rotate-y-180 relative ml-[2vw] mr-[2vw] w-[clamp(1em,11vw,100em)] pt-[5vh] pb-[5vh] transform-3d duration-150 shadow-sm": "ml-[2vw] mr-[2vw] w-[clamp(1em,11vw,100em)] pt-[5vh] pb-[5vh] relative transform-3d duration-150 shadow-sm"}> 
                ...
                <div className="absolute inset-0 flex flex-col items-center bg-[#F1EDFF] border-2 border-violet-400 rotate-y-180 hide-back hover:bg-violet-400 transform duration-500 shadow-sm"> 
                    <div className="flex justify-center items-center"> 
                        <FlipButton flipped={flipped} flipOver={flipOver} cantFlip={cantFlip}/>
