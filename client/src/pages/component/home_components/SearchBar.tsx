...
function SearchBar({query, setQuery, clickButton, setValue, value, setAllDayEvents, setEvents}: Props) {
    ...
    return (
        <div className="bg-[#3B1F0E] w-[76vw] h-[5vh] rounded-[4vw] pl-[clamp(1rem,2vw,100rem)] pt-1 pb-1 focus:outline-0 text-[#FFF8F0] border border-[#4A7C59] flex items-center shadow-[0_4px_25px_0_rgba(0,0,0,0.2)]">
