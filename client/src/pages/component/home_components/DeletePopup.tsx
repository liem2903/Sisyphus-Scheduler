                    ...
                    <div className="bg-black/50 absolute inset-0" onClick={() => deletePopup(false)}> </div>
                        <div className="w-[clamp(25rem,40vw,100rem)] z-1008 bg-[#3B1F0E] absolute flex items-center flex-col gap-[3vh] rounded-lg shadow-[inset_0_4px_5px_0_rgba(0,0,0,0.3)] pb-[1vh] pt-[1vh]">  
                            ...
                            <div className="flex gap-[1vw]"> 
                                <div className="bg-[#60ac75] w-32 h-10 text-lg flex justify-center items-center rounded-lg shadow-[inset_0_4px_25px_0_rgba(0,0,0,0.2)] cursor-pointer text-white font-bold hover:scale-105 transition duration-250" onClick={() => handleClick()}> Yes </div>
                                <div className="bg-[#8B3A3A] w-32 h-10 text-lg flex justify-center items-center rounded-lg shadow-[inset_0_4px_25px_0_rgba(0,0,0,0.2)] cursor-pointer text-white font-bold hover:scale-105 transition duration-250" onClick={() => deletePopup(false)}>No</div>
                            </div>
                        </div>
                </div>
    </>
