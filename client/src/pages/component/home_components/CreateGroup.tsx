...
function CreateGroup({openAddGroup}: prop) {
    ...
    return <>
        <div className="flex justify-center items-center inset-0 absolute z-1008">
           ...
           <div className="w-[clamp(25rem,40vw,100rem)] z-1008 bg-[#3B1F0E] absolute flex items-center flex-col gap-[3vh] rounded-lg shadow-[inset_0_4px_5px_0_rgba(0,0,0,0.3)] pb-[1vh]" onClick={() => setExtend(false)}>
