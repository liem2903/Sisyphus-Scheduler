...
function CreateGroup({openAddGroup}: prop) {
    ...
    return <>
        <div className="flex justify-center items-center inset-0 absolute z-1008">
           ...
           <div className="w-[clamp(25rem,40vw,100rem)] aspect-3/2 z-1008 bg-[#3B1F0E] rounded-2xl absolute flex items-center flex-col gap-[3vh]" onClick={() => setExtend(false)}>
                <div className={["flex w-[clamp(20rem,38vw,100rem)] mt-10 rounded-[1vw] z-999 max-h-[5vh] overflow-x-clip gap-0", focused ? "bg-white/30" : "bg-white"].join(" ")}>
